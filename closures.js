...
function outer() {
  ...
  */
    ...
    //IRL var jakeCall = callFriend('Jake')('435-555-9248');
  ...
  */
  ...
  function secretNumber() {
    ...
    return {
      addToSecret: function(addThisMuch) {
        return secret += addThisMuch;
      },
      takeAwayFromSecret: function(takeAwayThisMuch) {
        return secret -= takeAwayThisMuch;
      }
    }
  }
  ...
  function timeOutCounter() {
    var counter = 0;
    for (var i = 0; i <= 5; i++) {
      setTimeout(function() { console.log(counter++) }, i * 1000)
    }
  }
  ...
  function timeOutCounter() {
    for (var i = 0; i <= 5; i++) {
      (function (j) {
        return setTimeout(function() { console.log(j) }, x * 1000);
      })(i)
    }
  }
